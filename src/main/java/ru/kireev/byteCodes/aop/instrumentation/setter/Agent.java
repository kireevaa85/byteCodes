package ru.kireev.byteCodes.aop.instrumentation.setter;
...
public class Agent {
  public static void premain(String agentArgs, Instrumentation inst) {
    ...
    inst.addTransformer(new ClassFileTransformer() {
      ...
      public byte[] transform(ClassLoader loader, String className,
        ...
        if (className.equals("ru/kireev/byteCodes/aop/instrumentation/setter/MyClass")) {
  ...
  private static byte[] addMethod(byte[] originalClass) {
    ...
    mv.visitFieldInsn(Opcodes.PUTFIELD, "ru/kireev/byteCodes/aop/instrumentation/setter/MyClass", "value", "I");
